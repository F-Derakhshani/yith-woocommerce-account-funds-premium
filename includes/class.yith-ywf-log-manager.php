	...
	class YITH_YWF_Log_Manager{
		...
		public function install(){
			...
			if( version_compare($db_version, '1.0.0','<' ) ){
				...
				update_option('ywf_dbversion', YITH_FUNDS_DB_VERSION );
			}
		}
		...
		public function add_log( $args = array() ){
			...
			$default['fund_user'] =  ( $default['type_operation'] === 'pay' || $default['type_operation'] === 'remove' ) ? -$default['fund_user'] :  $default['fund_user'] ;
