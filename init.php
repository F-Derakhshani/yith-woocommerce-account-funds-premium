 ...
 * Plugin URI: http://yithemes.com/themes/plugins/yith-woocommerce-account-funds/
 * Description: Give your customers the possibility to deposit funds in their WooCommerce account now and use them later at any time to checkout more quickly
 * Version: 1.0.17
 * Author: YITHEMES
...
if ( !defined( 'YITH_FUNDS_VERSION' ) ) {
    define( 'YITH_FUNDS_VERSION', '1.0.17' );
}
...
if( !defined('YITH_FUNDS_DB_VERSION' ) ){
	define( 'YITH_FUNDS_DB_VERSION','1.0.0' );
}
